...
const MobileMenuButton = () => {
    ...
    return (
        <div className="sm:block md:hidden">
            <button data-collapse-toggle="navbar-search" type="button" className=" p-1 items-center p-2 ms-1 me-1 my-1 justify-center text-sm font-medium text-gray-500 rounded-lg hover:bg-gray-300 focus:outline-none ring-4 ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:ring-gray-600" aria-controls="navbar-search" aria-expanded="false" onClick={handleMneuClick}>
